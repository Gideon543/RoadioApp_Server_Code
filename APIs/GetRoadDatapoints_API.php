...
namespace controllers;
    require_once __DIR__."/../controllers/road_datapoint_controller.php";
    ...
    if(isset($_GET['apicall'])){
        ...
        if ($_GET['apicall'] == "getRoadData"){
            ...
            $roadDatapointController = new RoadDatapointController();

            // Getting all road datapoints from the database
            $resultsFromOperation = $roadDatapointController ->getRoadDatapoints();
